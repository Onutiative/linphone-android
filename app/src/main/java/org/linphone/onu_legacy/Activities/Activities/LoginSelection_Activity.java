 ...
 * profile.
 */
public class LoginSelection_Activity extends AppCompatActivity implements
        GoogleApiClient.OnConnectionFailedListener,
        View.OnClickListener {

    private static final String TAG = "LoginSelection_Activity";
    ...
    private void signIn() {
        ...
        startActivity(new Intent(LoginSelection_Activity.this, LoginActivity.class));
