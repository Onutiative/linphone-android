 ...
 */
public class DeliveryReport extends AsyncTask<Void, Void, String>  {
    ...
    public DeliveryReport(Context context, String imei, String sid)
        {
    ...
    protected String doInBackground(Void... params) {
        ...
        for (Contact cn : contacts)
        {
            ...
            //infobuzzer inside the optimal inside.
            ...
            Log.v("Jhoro", "Delivery_doinbak_doinback");
            try {
                Log.v("Jhoro", "Delivery_doinbak_SendOut");
                ...
                jsonParam.accumulate("delivery_status", "Delivered");
                jsonParam.accumulate("delivery_response", "Delivered");
                ...
                Log.v("Jhoro", "Delivery_doinbak_Data" + entity);
                ...
                Log.v("Jhoro", "Response:" + response_data);
