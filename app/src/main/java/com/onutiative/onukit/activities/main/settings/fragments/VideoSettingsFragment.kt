 ...
 */
package com.onutiative.onukit.activities.main.settings.fragments
...
class VideoSettingsFragment : GenericSettingFragment<SettingsVideoFragmentBinding>() {
    ...
    private fun initVideoCodecsList() {
        ...
        for (payload in coreContext.core.videoPayloadTypes) {
            ...
            binding.setVariable(com.onutiative.BR.switch_title, payload.mimeType)
            binding.setVariable(com.onutiative.BR.switch_subtitle, "")
            binding.setVariable(com.onutiative.BR.text_title, "recv-fmtp")
            binding.setVariable(com.onutiative.BR.text_subtitle, "")
            binding.setVariable(com.onutiative.BR.defaultValue, payload.recvFmtp)
